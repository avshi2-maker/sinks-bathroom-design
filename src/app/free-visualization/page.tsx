...
export const metadata: Metadata = {
  ...
  description:
    "שלחו תמונה של האמבטיה או המטבח שלכם וקבלו הדמיה חינם של כיור שיש איטלקי מותאם אישית — ללא עלות וללא התחייבות. תוך 24-48 שעות נחזור עם הדמיה מציאותית וטווח מחירים.",
  keywords: [
    "הדמיה חינם כיור שיש",
